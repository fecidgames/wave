...
TrailEntity::TrailEntity(int32_t x, int32_t y, ID id, uint32_t uid, int32_t life, sf::Color c, EntityHandler& e, int32_t scale) : scale(scale), x(x), y(y), id(id), uid(uid), life(life), c(c), e(e) {
